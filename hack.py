...
def superuser():
    ...
    if id in DARK:
        ...
        os.system("clear")
        print(logo)
        print("\t\033[30m   [\033[1;32m\033[47m Approvel done \033[00m\033[1;30m]")
        print ("")
        print("┌━═━═━═━═━━═━═━═━═━═━═━═━━═━═━═━═━═━═━═━━═━═━═━═━═━═━═━┐ \n\033[1;32m│ Note : That is Paid because 100% ok id just now login│\033[1;37m\n└━═━═━═━═━━═━═━═━═━═━═━═━━═━═━═━═━═━═━═━━═━═━═━═━═━═━═━┘")
        print ("")
        print("                approval done only 2 minit")
        print("                00")
        print ("")
        ...
        os.system(f"espeak \"{name} ,approval done\"")
        print ("")
        input(" ID HACK DONE = 100069217821581 = shuvo@@@")
        os.system("xdg-open https://www.facebook.com/profile.php?id=61551586276657")
        superuser()        
superuser()
